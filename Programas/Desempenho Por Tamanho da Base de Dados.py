...
matrixAP.to_csv("Desempenho_Apriori_sup" + str(supp) + "_conf" + str(conf) + ".csv", sep=';', decimal=',')
matrixFP.to_csv("Desempenho_FP-Growth_sup" + str(supp) + "_conf" + str(conf) + ".csv", sep=';', decimal=',')
